...
model = LlamaForCausalLM.from_pretrained("mistralai/Mistral-7B-Instruct-v0.3", device_map = "cuda:0")
...
for cat in cat_list:
  ...
  with open(f"exp_data/beaver_results_mistral/{cat}_outputs.json", "w+") as fp:
